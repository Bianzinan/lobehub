export default {
  ...
  'builtins.lobe-agent-marketplace.apiName.showAgentMarketplace': 'Assembling your agent team',
  'builtins.lobe-agent-marketplace.apiName.submitAgentPick': 'Submit agent picks',
  'builtins.lobe-agent-marketplace.category.business-strategy': 'Business strategy',
  'builtins.lobe-agent-marketplace.category.content-creation': 'Content creation',
  'builtins.lobe-agent-marketplace.category.creator-economy': 'Creator economy',
  'builtins.lobe-agent-marketplace.category.design-creative': 'Design & creative',
  'builtins.lobe-agent-marketplace.category.engineering': 'Engineering',
  'builtins.lobe-agent-marketplace.category.finance-legal': 'Finance & legal',
  'builtins.lobe-agent-marketplace.category.learning-research': 'Learning & research',
  'builtins.lobe-agent-marketplace.category.marketing': 'Marketing',
  'builtins.lobe-agent-marketplace.category.operations': 'Operations',
  'builtins.lobe-agent-marketplace.category.people-hr': 'People & HR',
  'builtins.lobe-agent-marketplace.category.personal-life': 'Personal & life',
  'builtins.lobe-agent-marketplace.category.product-management': 'Product management',
  'builtins.lobe-agent-marketplace.category.sales-customer': 'Sales & customer',
  'builtins.lobe-agent-marketplace.inspector.moreCategories_one': '+{{count}}',
  'builtins.lobe-agent-marketplace.inspector.moreCategories_other': '+{{count}}',
  'builtins.lobe-agent-marketplace.inspector.pickCount_one': '{{count}} agent',
  'builtins.lobe-agent-marketplace.inspector.pickCount_other': '{{count}} agents',
